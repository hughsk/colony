 ...
 */</span>
<span class="comment">// Patch for jsdom</span>
module.exports = <span class="keyword">function</span>(document){
...
<span class="keyword">var</span> Sizzle = <span class="keyword">function</span>( selector, context, results, seed ) {
	results = results || [];
	<span class="comment">// PATCH for jsdom</span>
	<span class="comment">// context = context || document;</span>
	<span class="comment">// See: https://github.com/tmpvar/jsdom/issues/375</span>
	context = context || seed[<span class="number">0</span>].ownerDocument;
...
<span class="comment">// Patch for jsdom</span>
<span class="keyword">if</span> ( document.querySelectorAll &amp;&amp; <span class="literal">false</span> ) {
	(<span class="keyword">function</span>(){
...
<span class="keyword">return</span> Sizzle;
